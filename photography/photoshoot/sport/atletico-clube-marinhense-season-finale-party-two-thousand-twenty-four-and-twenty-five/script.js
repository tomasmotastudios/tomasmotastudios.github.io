...
document.addEventListener('DOMContentLoaded', () => {
  ...
  for (let i = 1; i <= 434; i++) {
    ...
    div.className = "overflow-hidden rounded-xl shadow-lg flex items-center justify-center bg-black";

    const img = document.createElement("img");
    img.src = `src/img/${i}.jpg`;
    img.alt = `Foto ${i}`;
    img.className = "w-full object-contain cursor-pointer hover:scale-105 transition-transform duration-500";
